...
export default function Project(props) {
    ...
    const handleMouseMove = (e) => {
        ...
        imageElement.style.transform = `perspective(500px) rotateY(${dx * 3}deg) rotateX(${-dy * 3}deg)`;
    };
    ...
    return (
        <div className={`flex ${props.flexDirection} flex-col bg-[#1e293b99] box-shadow-gray p-5 rounded-2xl gap-5`}>
            ...
            <div className='flex flex-col gap-5 justify-center items-center text-center bg-[#293548] rounded-2xl box-shadow-gray lg:max-w-[25rem] py-5 lg:py-0'>
                ...
                <p className='text-1 text-base font-medium w-[90%]'>{props.description}</p>
                <div className='flex flex-wrap justify-center gap-3'>
                    <span class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs sm:text-sm font-medium bg-blue-100 text-blue-800">{props.tech[0]}</span>
                    <span class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs sm:text-sm font-medium bg-blue-100 text-blue-800">{props.tech[1]}</span>
                    <span class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs sm:text-sm font-medium bg-blue-100 text-blue-800">{props.tech[2]}</span>
                </div>
                <div className='flex gap-10'>
                    <a href={props.github} target="_blank" rel="noreferrer" className='flex gap-1 items-center link-w-svg'>
                        <p className='text-1 text-lg'>Code</p>
                    ...
                    <a href={props.live} target="_blank" rel="noreferrer" className='flex items-center link-w-svg'>
                        <p className='text-1 text-lg'>View Live</p>
